 ...
 */
var hrmApp = angular.module('hrmApp',['ngMaterial','ngMessages','ngFileUpload','ngResource','ngStorage','satellizer','sasrio.angular-material-sidenav','md.data.table','ui.router','ngRoute','ngCookies']);
...
/*
        ...
        $authProvider.loginUrl = 'http://localhost/hrm/public/authenticate';
